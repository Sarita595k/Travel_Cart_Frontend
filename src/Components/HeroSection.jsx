...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen overflow-hidden flex flex-row items-center justify-evenly max-md:flex-col">
            ...
            {/* 3. THE MAIN FRAME (Combined Overlay + Navbar Container) */}
            {/* Added pointer-events-none here so it doesn't block layers underneath, 
                BUT we will re-enable it for the Navbar inside */}
            <div className="absolute top-10 bottom-10 left-10 right-10 bg-black/20 z-10 rounded-2xl border border-white/10 overflow-hidden flex flex-col pointer-events-none">
                ...
                {/* Navbar - We force pointer-events-auto so links work! */}
            ...
            {/* 4. SOLAR SYSTEM - Must have pointer-events-none */}
            ...
            {/* 5. LIZARD IMAGE - pointer-events-none */}
            ...
            {/* 8. PLANE OVERLAY - pointer-events-none */}
